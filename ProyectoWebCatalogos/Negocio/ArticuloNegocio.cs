...
namespace Negocio
{
    public class ArticuloNegocio
    {
        ...
        public List<Articulo> ListarSP()
        {
            ...
            try
            {
                datos.SetearConsulta("storedListarArticulos");
                datos.EjecutarLectura();
                while (datos.Lector.Read())
                {
                    Articulo articulo = new Articulo();
        ...
        public void ModificarArticuloSP(Articulo articulo)
        {
            ...
            try
            {
                ...
                datos.SetearSP("ModificarArticulo");
                datos.SetearParametros("Id", articulo.Id);
                datos.SetearParametros("codigo", articulo.Codigo);
                datos.SetearParametros("nombre", articulo.Nombre);
                datos.SetearParametros("descripcion", articulo.Descripcion);
        ...
        public void EliminarArticuloSP(int id)
        {
            AccesoDatos datos = new AccesoDatos();
            try
            {
                datos.SetearSP("EliminarArticulo");
                datos.SetearParametros("Id", id);
                datos.EjecutarAccion();
            }
            catch (Exception)
        ...
        public Articulo BuscarArticuloSP(int id)
        {
            Articulo articulo = new Articulo();
            AccesoDatos datos = new AccesoDatos();
            try
            {
                datos.SetearSP("BuscarArticulo");
                datos.SetearParametros("Id", id);
                datos.EjecutarLectura();
                while (datos.Lector.Read())
                {
